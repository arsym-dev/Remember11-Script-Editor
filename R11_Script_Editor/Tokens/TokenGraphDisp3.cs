...
{
    class TokenGraphDisp3 : Token
    {
        public new const TokenType Type = TokenType.graph_disp;
        
        byte num_entries;
        public List<GraphDispEntry3> Entries = new List<GraphDispEntry3>();

        public TokenGraphDisp3(bool blank=false)
        {
            _command = "Graph Disp3";
            ...
            {
                num_entries = 3;
                Entries.Add(new GraphDispEntry3()
                {
                    ImageNumber = 256,
                    Unknown2 = 7935,
        ...
        public override void UpdateGui()
        {
            ...
            PopulateEntryList(Entries, (sender, ev) => {
                if (ev.AddedItems.Count == 0 || !(ev.AddedItems[0] is GraphDispEntry3))
                    return;

                base.UpdateGui(false);
                var e = (GraphDispEntry3)ev.AddedItems[0];
